...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        path.add("F:/罗斐语料/罗斐所需语料/绿色食品与饥饿（韩国）/");
        path.add("F:/罗斐语料/罗斐所需语料/绿色食品与饥饿（日本）/");
        path.add("F:/罗斐语料/罗斐所需语料/记对我影响最大的一个人（韩国）/");
        path.add("F:/罗斐语料/罗斐所需语料/记对我影响最大的一个人（日本）/");
       ...
       // File file = new File("F:/罗斐语料/罗斐所需语料/记对我影响最大的一个人（日本）/");
        for(int k = 0; k<8 ; k++) {
            File file = new File(path.get(k/2));
            System.out.println(path.get(k/2));
            ...
            if (file.isDirectory()) {
                ...
                controller.run("F:/罗斐语料/罗斐所需语料/结果",k);
